...
namespace KnowledgeStore.Areas.AdminArea.Controllers
{
    public class QuanLySachController : BaseController
    {
        ...
        public ActionResult DuyetSach(int id)
        {
            ...
            MailHelper.SendMailOfMer(sach.Merchant.TenCuaHang, sach.Merchant.Email, "Thông báo tình trạng Tin Sách", "Sách mã " + sach.SachID + " tên " + sach.TenSach + " đã được duyệt");
