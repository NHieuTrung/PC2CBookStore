...
namespace KnowledgeStore.Areas.AdminArea.Controllers
{
    public class ADHomeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                tongXu = db.LichSuGiaoDichXuCuaMerchants.Where(m=>m.PhuongThucSuDung=="Paypal").Sum(m => m.SoXu);
            }
            ...
            var listLSGDXu = db.LichSuGiaoDichXuCuaMerchants.Where(m=>m.PhuongThucSuDung=="Paypal").OrderByDescending(m => m.NgayGiaoDich);
