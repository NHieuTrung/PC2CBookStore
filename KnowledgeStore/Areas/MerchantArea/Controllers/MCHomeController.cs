...
namespace KnowledgeStore.Areas.MerchantArea.Controllers
{
    public class MCHomeController : Controller
    {
        ...
        public ActionResult OverallPage()
        {
            ...
            var listCTDBanDuoc = db.ChiTietDonHangs.Where(m => m.DonHang.NgayDat.Year == date.Year & m.DonHang.NgayDat.Month == date.Month & m.DonHang.NgayDat.Day == date.Day & m.TinhTrangDonHangID == 4&m.Sach.MerchantID== merchantID);
